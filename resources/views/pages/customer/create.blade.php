...
<div class="page-header">
    <div class="d-flex justify-content-between align-items-center flex-wrap">
        <div class="text-white">
            ...
            <p class="mb-0 opacity-75">Tambahkan data pelanggan baru ke dalam sistem</p>
        </div>
    </div>
    ...
    <div class="col-lg-8">
        <div class="card form-card">
            <div class="card-header">
                <h5 class="mb-0"><i class="bi bi-pencil-square me-2"></i>Form Data Pelanggan</h5>
            </div>
            <div class="card-body">
                <form action="{{ route('customer.store') }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="phone" class="form-control" required placeholder="08...">
                        </div>
                        <div class="col-md-6 mb-3">
