    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-4 flex-none">
        <div>
            <h1 class="text-2xl font-bold text-slate-800 flex items-center gap-2">
                <i data-lucide="pencil" class="h-6 w-6 text-[#84994F]"></i> Edit Template
            </h1>
            <p class="text-sm text-slate-500 mt-1">Perbarui konfigurasi pesan template.</p>
        </div>
    ...
    <div class="w-full bg-white rounded-xl shadow-sm border border-slate-100 flex flex-col h-[calc(100vh-160px)] overflow-hidden">
        ...
        <div class="flex-1 overflow-y-auto custom-scrollbar relative">
            <div class="p-6 md:p-8">
                <form action="{{ route('admin.templates.update', $template->id) }}" method="POST" id="templateForm">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-5">
                        ...
                        <input type="text" name="name" value="{{ old('name', $template->name) }}" placeholder="Contoh: Promo Gajian, Reminder H-3" required
                    ...
                    <div class="mb-6">
                        ...
                        <textarea name="content" id="contentArea" rows="12" placeholder="Tulis pesan Anda di sini..." required
                            ...
                            oninput="updatePreview()">{{ old('content', $template->content) }}</textarea>
