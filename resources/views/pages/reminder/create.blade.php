    ...
    <div class="col-lg-8">
        <div class="card shadow-sm">
            <div class="card-header bg-primary text-white">
                <h5 class="mb-0"><i class="bi bi-plus-circle me-2"></i>Buat Reminder Baru</h5>
            </div>
            <div class="card-body">
                <form action="{{ route('reminders.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('days_after_delivery') is-invalid @enderror" 
                               ...
                               value="{{ old('days_after_delivery', 25) }}" 
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('message_template') is-invalid @enderror" 
                                  ...
                                  rows="6" required>{{ old('message_template', "Halo {customer_name}! 👋\n\nSudah {days_since} hari sejak Anda membeli {product_name} dari kami.\nApakah stok Anda sudah mulai menipis?\n\nYuk order lagi sebelum kehabisan! 😊") }}</textarea>
                    ...
                    <div class="d-flex gap-2">
                        <button type="submit" class="btn btn-primary">
                            <i class="bi bi-save me-1"></i>Simpan Reminder
                        </button>
